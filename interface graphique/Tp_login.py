...
# labels
Label(frame,text="Nouveau compte",font=("Times", "24", "bold")).grid(row=0, columnspan=3, pady=10)

Label(frame, text='Nom', font=("Times", "14")).grid(row=1, column=0, pady=5)


Label(frame, text='Prénom', font=("Times", "14") ).grid(row=2, column=0, pady=5)

Label(frame, text='Email Address', font=("Times", "14")).grid(row=3, column=0, pady=5)

Label(frame, text='Password', font=("Times", "14")).grid(row=4, column=0, pady=5)



# Entry
nom = Entry(frame, width=30)
nom.grid(row=1, column=1)

pre = Entry(frame, width=30)
em = Entry(frame, width=30)
pwd = Entry(frame,show="*", width=30)
...
# button
clr = Button(frame, text="Clear", padx=20, pady=10, relief=SOLID, font=("Times", "14", "bold"), command=clear)
reg = Button(frame, text="Créer le compte", padx=20, pady=10, relief=SOLID, font=("Times", "14", "bold"), command=create)
ext = Button(frame, text="Exit", padx=20, pady=10, relief=SOLID, font=("Times", "14", "bold"), command=lambda:frame.pack_forget())
disp = Button(frame, text="Display", padx=20, pady=10, relief=SOLID, font=("Times", "14", "bold"), command=display)
